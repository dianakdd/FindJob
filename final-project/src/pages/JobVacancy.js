...
const JobVacancy = () => {
    ...
    let {truncateString} = handleFunction 
    ...
    return(
        <>
            <section className="">
                <div class="container mx-auto px-6 py-16 pt-28 text-center">
                    <div class="mx-auto max-w-lg ">
                        <h1 class="text-3xl font-bold text-gray-800 dark:text-white md:text-4xl">Try to find your own passion?</h1>

                        <p class="mt-6 text-gray-500 dark:text-gray-300">We present a list of jobs that you want</p>
                        ...
                        <div class="mx-auto mt-6 w-full max-w-sm rounded-md border bg-transparent focus-within:border-blue-400 focus-within:ring focus-within:ring-blue-300 focus-within:ring-opacity-40 dark:border-gray-700 dark:focus-within:border-blue-300">
                            <form onSubmit={handleSearch} class="flex flex-col md:flex-row">
                            <input onChange={handleChangeSearch} value={search} type="search" id="default-search"  placeholder="Search job ..." class="m-1 h-10 flex-1 appearance-none border-none bg-transparent px-4 py-2 text-gray-700 placeholder-gray-400 focus:placeholder-transparent focus:outline-none focus:ring-0 dark:text-gray-200" />

                            <button onClick={handleClickScroll} type="submit" class="m-1 h-10 transform rounded-md bg-blue-500 px-4 py-2 text-white transition-colors duration-300 hover:bg-blue-400 focus:bg-blue-400 focus:outline-none">Search</button>
                            </form>
                        </div>
                    </div>

                    <div class="mx-auto pb-16 mt-32 max-w-screen-xl">
                        <div class="grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
                            <div class="col-span-1 flex items-center justify-center md:col-span-2 lg:col-span-1">
                                <svg class="h-16 fill-current text-gray-500 dark:text-gray-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 266 100">
                            ...
                            <div class="col-span-1 flex items-center justify-center md:col-span-2 lg:col-span-1">
                                <svg class="h-12 fill-current text-gray-500 dark:text-gray-300" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 316 60">
                            ...
                            <div class="col-span-1 flex items-center justify-center md:col-span-2 lg:col-span-1">
                                <svg class="mt-2 h-10 fill-current text-gray-500 dark:text-gray-300" viewBox="0 0 398 120" xmlns="http://www.w3.org/2000/svg">
                                    <g fill-rule="nonzero">
                            ...
                            <div class="col-span-1 flex items-center justify-center md:col-span-3 lg:col-span-1">
                                <svg class="mt-1 h-10 fill-current text-gray-500 dark:text-gray-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 278.7 36.3">
            ...
            <section id="section-2" className="bg-white gap-7 dark:bg-gray-900">
                <div className="py-8 px-4 container mx-auto max-w-screen-xl lg:py-13 lg:px-6">
                    <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                        ...
                        <p class="mt-6 text-gray-500 dark:text-gray-300">Make the best decision for your career and build your dream career!</p>
                    </div>
                    ...
                    <div className="flex mt-5 mb-5">
                        <form onSubmit={handleFilter} className="w-full">   
                            ...
                            {/* <button type="submit" className="mt-5 text-white right-2.5 bottom-2.5 bg-black focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium text-sm rounded-lg px-5 py-2">Filter</button> */}
                    ...
                    <div className="grid grid-cols-1  gap-8 mt-14 mb-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
                    { data !== null && data.map((res, index) => {
                            return (
                                <Link to={`/job-vacancy/detail/${res.id}`} value={res.id} key={res.id} className="relative items-center justify-center mx-auto bg-white py-6 px-6 rounded-3xl w-64 my-4 shadow-xl">
                                <div className=" text-white flex items-center absolute rounded-full py-2 px-2 shadow-xl bg-gray-200 left-4 -top-6">
                                    <img src={res.company_image_url} className="h-12 w-12 rounded-full" fill="none" viewBox="0 0 24 24" stroke="currentColor"/>
                                    
                                </div>
                                <div className="mt-8">
                                    <p className="text-xl font-semibold my-2">{res.title}</p>
                                    <div className="flex space-x-2 text-gray-400 text-sm">
                                        <HiOutlineBuildingOffice className="h-5 w-5 gray-400" style={{color: "#9ca3af",}} />
                                    ...
                                    <div className="flex space-x-2 text-gray-400 text-sm my-3">
                                        ...
                                        <p>{res.company_city} | {res.job_tenure}</p> 
                                    </div>
                                    <div className="flex space-x-2 text-gray-400 text-sm my-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                        </svg>
                                        <p>{moment(res.created_at, "YYYYMMDD h:mm:ss").fromNow()}</p> 
                                    </div>
                                    <div className="border-t-2"></div>

                                    <div className="flex justify-between">
                                    <p className="text-sm mt-1 text-gray-400">{truncateString(res.job_description,100)}</p>
                                    </div>
                                </div>
                            </Link>
                        )
